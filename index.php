...
<header class="header">
   ...
   <a class="logo"><img src="img/logo_white.png" alt="logo"></a>
   </div>
        <div class="col-md-12 text-center">
...
<section id="aboutus">
 ...
 <div class="container">
   <h3 class="text-center"><br><br>DineBook</h3>
   <div class="row">
<!--carousel-->
...
<!--end of carousel-->
	...
	<p><br>Welcome to our DineBook. Our platform is all about making your life easier. No more waiting on hold or frantically searching the internet for a reservation. 
            With just a few clicks, you can book a table at your favorite restaurant and get back to doing what you love - eating!
            <br>Let's get you seated and start the feast!<br><br></p><hr>
	</div>
     </div>
    </div><br>
  </div>
...
?>
            ...
            <div class="col">
            <h4 class="text-right"><strong>Contact Us</strong></h4>
            <p class="text-right">DineBook<br>  
            <br>email: info@dinebook.com
            <br>phone: +254(123) 456 789</p>
            </div>
